...
![认识容器](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472776296.png)

### 1.2 图解物理机,虚拟机与容器
关于虚拟机与容器的对比在后面会详细介绍到，这里只是通过网上的图片加深大家对于物理机、虚拟机与容器这三者的理解。

**物理机**
![物理机](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472777082.jpg)

**虚拟机：**

![虚拟机](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472776730.jpg)

**容器：**

![容器](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472777016.jpg)
...
![Docker的一些概念](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472776356.png)
...
![什么是Docker](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472776110.jpg)
...
![容器 VS 虚拟机](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472774083.jpg)

### 3.2 容器与虚拟机总结

![容器与虚拟机 (VM) 总结](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472775137.jpg)
...
![两者是可以共存的](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472774704.jpg)
...
![Docker 包括三个基本概念](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472774923.jpg)
...
{
  "registry-mirrors": ["https://pk1s0maj.mirror.aliyuncs.com"]
}
EOF
...
![build ship run](https://cdn.jsdelivr.net/gh/qoo3/imgur@master/bookmaker/1589472774906.jpg)
